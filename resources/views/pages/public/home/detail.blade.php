                        ...
                        <div class="col-md-6">
                            <div class="product-gallery product-gallery-separated">
                                ...
                                <figure class="product-separated-item">
                                    <img src="{{ asset('storage/images') }}/products/single/sticky/1.jpg"
                                        data-zoom-image="{{ asset('storage/images') }}/products/single/sticky/1-big.jpg"
                                        alt="product image">
                                </figure>
                                <figure class="product-separated-item">
                                    <img src="{{ asset('storage/images') }}/products/single/sticky/2.jpg"
                                        data-zoom-image="{{ asset('storage/images') }}/products/single/sticky/2-big.jpg"
                                        alt="product image">
                                </figure>

                                <figure class="product-separated-item">
                                    <img src="{{ asset('storage/images') }}/products/single/sticky/3.jpg"
                                        data-zoom-image="{{ asset('storage/images') }}/products/single/sticky/3-big.jpg"
                                        alt="product image">
                                </figure>

                                <figure class="product-separated-item">
                                    <img src="{{ asset('storage/images') }}/products/single/sticky/4.jpg"
                                        data-zoom-image="{{ asset('storage/images') }}/products/single/sticky/4-big.jpg"
                                        alt="product image">
                                </figure>
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            ...
                            <a href="{{ route('detail') }}">
                                <img src="{{ asset('storage/images') }}/products/product-6.jpg" alt="Product image"
                                    class="product-image">
                            </a>
                            <div class="product-action">
                                <a href="#" class="btn-product btn-cart"><span>add to cart</span></a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            ...
                            <a href="{{ route('detail') }}">
                                <img src="{{ asset('storage/images') }}/products/product-11.jpg" alt="Product image"
                                    class="product-image">
                            </a>
                            <div class="product-action">
                                <a href="#" class="btn-product btn-cart"><span>add to cart</span></a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            <a href="{{ route('detail') }}">
                                <img src="{{ asset('storage/images') }}/products/product-10.jpg" alt="Product image"
                                    class="product-image">
                            </a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            <a href="{{ route('detail') }}">
                                <img src="{{ asset('storage/images') }}/products/product-7.jpg" alt="Product image"
                                    class="product-image">
                            </a>
                            <div class="product-action">
                                <a href="#" class="btn-product btn-cart"><span>add to cart</span></a>
